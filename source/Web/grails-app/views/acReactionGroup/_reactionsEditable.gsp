    	<ui:field name="acReactionGroup.reactions">
    		<ui:fieldInput>
    			<div class="row-fluid">
            		<gui:table list="${instance.reactionSet.reactions}" showEnabled="true" editEnabled="true" deleteEnabled="true">
        				...
        				<gui:column label="Associated">
                            <g:checkBox name="contains${index}" value="${instance.containsReaction(bean)}"/>
        				</gui:column>
        			</gui:table>
        		</div>
			</ui:fieldInput>
