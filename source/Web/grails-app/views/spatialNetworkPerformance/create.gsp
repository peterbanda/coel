...
<body>
	<theme:zone name="body">
		...
		<div> 
			<ui:form remote="true" name="runPerformanceEvaluationForm" url="[controller: 'spatialNetworkPerformance', action: 'runPerformanceEvaluation']" before="showPerformanceEvaluationLaunchSuccessDialog();" >
				...
				<ui:field bean="instance" name="sizeFrom"/>
				<ui:field bean="instance" name="sizeTo"/>
