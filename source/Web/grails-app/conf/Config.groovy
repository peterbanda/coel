...
grails.plugins.springsecurity.interceptUrlMap = [
	...
	'/acReactionSet/exportAsOctaveMatlab/**': ['IS_AUTHENTICATED_ANONYMOUSLY'],
	...
	'/user/getLoggedUserEmailMD5':            ['ROLE_EXT_USER', 'ROLE_USER'],
	'/user/**':                               ['ROLE_ADMIN'],
	'/role/**':                               ['ROLE_ADMIN'],
	'/um/**':                                 ['ROLE_ADMIN'],
	'/jasper/**':                             ['ROLE_EXT_USER', 'ROLE_USER'],
	'/ac/**':                                 ['ROLE_EXT_USER', 'ROLE_USER'],
	'/artificialChemistry/generateACs':       ['ROLE_USER'],
	'/artificialChemistry/**':                ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acCompartment/**':                      ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acReactionSet/**':                      ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acReaction/**':                         ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acReactionGroup/**':                    ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acSpeciesSet/**':                       ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acSpecies/**':                          ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acParameterSet/**':                     ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acParameter/**':                        ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acInteractionSeries/**':                ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acInteraction/**':                      ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acSpeciesInteraction/**':               ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acInteractionVariableAssignment/**':    ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acTranslationSeries/**':                ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acTranslation/**':                      ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acTranslationItem/**':                  ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acSimulationConfig/**':                 ['ROLE_EXT_USER', 'ROLE_USER'],
	'/acRun/**':                              ['ROLE_EXT_USER', 'ROLE_USER'],
	'/chemPic/**':                            ['ROLE_EXT_USER', 'ROLE_USER'],
	'/**':                                    ['ROLE_USER'],
]