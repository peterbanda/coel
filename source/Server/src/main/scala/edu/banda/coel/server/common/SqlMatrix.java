...
class SqlMatrix<T> implements Array {
	...
	protected SqlMatrix(List<List<T>> data, int baseType) {
		this.data = data;
		this.baseType = baseType;
	}

	protected SqlMatrix(List<List<T>> data, int baseType, String baseTypeName) {
		this(data, baseType);
		this.baseTypeName = baseTypeName;
	}

	public static class BOOLEAN extends SqlMatrix<Boolean> {
		public BOOLEAN(List<List<Boolean>> data) {
			super(data, Types.BIT);
		}
	}

	public static class INTEGER extends SqlMatrix<Integer> {
		public INTEGER(List<List<Integer>> data) {
			super(data, Types.INTEGER);
		}
	}

	public static class LONG extends SqlMatrix<Long> {
		public LONG(List<List<Long>> data) {
			super(data, Types.BIGINT);
		}
	}

	public static class FLOAT extends SqlMatrix<Float> {
		public FLOAT(List<List<Float>> data) {
			super(data, Types.FLOAT);
		}
	}

	public static class DOUBLE extends SqlMatrix<Double> {
		public DOUBLE(List<List<Double>> data) {
			super(data, Types.DOUBLE);
		}
	}

	public static class STRING extends SqlMatrix<String> {
		public STRING(List<List<String>> data) {
			super(data, Types.VARCHAR, "text");
		}
	}

	public static class DATE extends SqlMatrix<Date> {
		public DATE(List<List<Date>> data) {
	...
	public String toString() {
		...
		for (List<T> list : data) {
			...
			for (T t : list) {
				...
				case Types.BIT:
				case Types.BOOLEAN:
					result.append(((Boolean) t).booleanValue() ? "true"
							: "false");
					break;
