...
class SqlListArray<T> implements Array {
	...
	protected SqlListArray(List<T> data, int baseType) {
		this.data = data;
		this.baseType = baseType;
	}

	protected SqlListArray(List<T> data, int baseType, String baseTypeName) {
		this(data, baseType);
		this.baseTypeName = baseTypeName;
	}

	public static class BOOLEAN extends SqlListArray<Boolean> {
		public BOOLEAN(List<Boolean> data) {
			super(data, Types.BIT);
		}
	}

	public static class INTEGER extends SqlListArray<Integer> {
		public INTEGER(List<Integer> data) {
			super(data, Types.INTEGER);
		}
	}

	public static class LONG extends SqlListArray<Long> {
		public LONG(List<Long> data) {
			super(data, Types.BIGINT);
		}
	}

	public static class FLOAT extends SqlListArray<Float> {
		public FLOAT(List<Float> data) {
			super(data, Types.FLOAT);
		}
	}

	public static class DOUBLE extends SqlListArray<Double> {
		public DOUBLE(List<Double> data) {
			super(data, Types.DOUBLE);
		}
	}

	public static class STRING extends SqlListArray<String> {
		public STRING(List<String> data) {
			super(data, Types.VARCHAR, "text");
		}
	}

	public static class DATE extends SqlListArray<Date> {
