...
import com.banda.network.business.NetworkDerridaAnalyser
 ...
 * @since 2014
 */
private class GridNetworkBooleanDerridaAnalysisCall[T](
	...
	override def call(task : NetworkRunTask[jl.Boolean]) = {
	    ...
	    val derridaAnalyser = NetworkDerridaAnalyser[jl.Boolean](
